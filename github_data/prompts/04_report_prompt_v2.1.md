...
### 용도
- 인터페이스 언어 TOP 7만 (언어 차트용)
- 필수 언어 5종/전략 포인트는 가이드로 유지

### 컬럼 설명
| 컬럼 | 타입 | 설명 | 예시 |
|------|------|------|------|
| support_type | 문자열 | 지원 타입 | `interface` |
| rank | 숫자 | 순위 1-7 | `1` |
| language | 문자열 | 언어명 | `영어` |
| game_count | 숫자 | 지원 게임 수 | `50` |
| percentage | 문자열 | 비율 | `100%` |
...
이 영역들은 AI 인사이트가 아닌 **일반 가이드**이므로 CSV 생성 대상이 아닙니다.
